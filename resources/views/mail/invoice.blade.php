      ...
      <div class="cs-invoice_in" id="download_section">
        <div class="cs-invoice_head cs-type1 cs-mb25">
          <div class="cs-invoice_left">
            <p class="cs-invoice_number cs-primary_color cs-mb5 cs-f16"><b class="cs-primary_color">Order Id (Tracking ID):</b> {{ $order['order_id'] }}</p>
            <p class="cs-invoice_date cs-primary_color cs-m0"><b class="cs-primary_color">Date: </b>{{ $order['date'] }}</p>
          </div>
          <div class="cs-invoice_right cs-text_right">
            <div class="cs-logo cs-mb5"><img src="{{ asset('frontend-assets') }}/assets/images/logo.png" alt="Logo" style="width: 178px;"></div>
          </div>
        </div>
          ...
          <div class="cs-round_border">
            <div class="cs-table_responsive">
              <table>
                ...
                <tbody>
                  <tr>
                    <td class="cs-width_3">{{ $details['product_name'] }}</td>
                    <td class="cs-width_2">{{ $details['quantity'] }}</td>
                    <td class="cs-width_1">{{ $details['single_price'] }}</td>
                    <td class="cs-width_2 cs-text_right">{{ $details['subtotal_price'] }}</td>
                  </tr>
                </tbody>
              </table>
            </div>
              ...
              <table>
                <tbody>
                  <tr class="cs-border_none">
                    ...
                    <td class="cs-width_3 cs-border_top_0 cs-bold cs-f16 cs-primary_color cs-text_right">{{ $order['total'] }}</td>
                  </tr>
                </tbody>
              </table>
            </div>
